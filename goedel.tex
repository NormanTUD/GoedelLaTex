...
\begin{enumerate}[1.]
	...
	\item $$
		v \text{ Geb } n, x \equiv \text{Var}\eft(v\right) \& \text{Form}\left(x\right) \& (Ea, b, c) [a, b, c \leqq x \& x a = \pmstar (v \text{ Gen } b \pmstar c \& \text{Form}(b) \& l(a) + 1 \leqq n \leqq l(a) + l(v \text{ Gen } b)]
		$$
