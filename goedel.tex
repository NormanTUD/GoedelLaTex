...
\begin{enumerate}[1.]
	...
	\item $n Th x \equiv \epsilon y \left\{ y \leqq x^{(x^n)} \& \left(k\right) \left[k \leqq l\left(x\right) \longrightarrow \left(k Gl x \leqq 13 \& k Gl y = k Gl x\right) \lor \left(k Gl x > 13 \& k Gl y = k Gl x.[1 Pr (k Gl x)]^n\right)\right]\right\}$
	...
	\item $R - Ax\left(x\right) \equiv (Eu, v, y, n) [u, v, y, n \leqq x \& n \text{ Var } v \& (n + 1) \text{ Var } u \&  u Fr y \& \text{Form }\left(y\right) \& x = u\text{ Ex } \left\{v \text{Gen } \left[\left[R(u) \pmstar E\left(R\left(v\right)\right)\right] \text{ Aeq } y \right]\right\} ]$
