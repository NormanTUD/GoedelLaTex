...
\glqq$[S; q]$\grqq) bloß eine \so{metamathematische Beschreibung} 
...
Aus der Bemerkung, daß $[R(q); q]$ seine eigene\mnote{Wenn der Satz $S = [R(q); q]$ unbeweisbar ist und 
...
$(a)\lor(b)$ nennen wir Disjunktion aus $a$ und $b$, 
$\thicksim(a)$ die Negation und $x\Pi(a)$ eine Generalisation von 
