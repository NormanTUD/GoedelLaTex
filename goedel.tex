...
\begin{enumerate}[1.]
	...
	\item $\text{Typ}_n\left(x\right) \equiv [n = 1 \& \text{Typ}_1'\left(x\right)] \lor [n > 1 \& (Ev) \{v \leqq x \& n\text{ Var } v \& x = R\left(v\right)\}]$
	...
	\item $$
		v \text{ Geb } n, x \equiv \text{Var}\left(v\right) \& \text{Form}\left(x\right) \& (Ea, b, c) [a, b, c \leqq x \& x a = \pmstar (v \text{ Gen } b \pmstar c \& \text{Form}(b) \& l(a) + 1 \leqq n \leqq l(a) + l(v \text{ Gen } b)]
		$$
	...
	\item $$
		L_2 - Ax\left(x\right) \equiv (Ev, q, p) \{v, q, p \leqq x \& \text{Var}\left(v\right) \& \text{Form}(p) \& v Fr p \& \text{Form}\left(x\right) \& x = [v \text{ Gen } (p\text{ Dis } q)]\}
		$$
	$x$ ist eine aus dem Axiomenschema III, 2 durch Einsetzung entstehende \textit{Formel}.

	\item $R - Ax\left(x\right) \equiv (Eu, v, y, n) [u, v, y, n \leqq x \& n \text{ Var } v \& (n + 1) \text{ Var } u \&  u Fr y \& \text{Form }(y) \& x = u\text{ Ex } \left\{v \text{Gen } \left[\left[R(u) \pmstar E\left(R\left(v\right)\right)\right] \text{ Aeq } y \right]\right\} ]$
	...
	\item $Fl(x\ y\ z) \equiv y = z \text{ Imp } x \lor (Ev) [ v \leqq x \& \text{ Var }\left(v\right) \& x = v \text{ Gen } y]$
