...
\begin{enumerate}[1.]
	...
	\left(n\right) [n \leqq l\left(x\right) \longrightarrow (n Gl z = n Gl x] \&
		\left(n\right) \left[0 < n \leqq (l\left(y\right) \longrightarrow (n + l\left(x\right)) Gl z = n Gl y\right]\right\}$ % TODO ) fehlt
	...
	\item $$
		FR\left(x\right) \equiv \left(n\right) \left\{ 0 < n \leqq l\left(x\right) \longrightarrow\allowbreak Elf(n Gl x) \lor \left(Ep, q\right)\allowbreak \left[0 < p, q < n \&\allowbreak Op\left(n Gl x, p Gl x, q Gl x\right)\right]\right\} \& l\left(x\right) > 0
		$$
	...
	\item $L_1 - Ax\left(x\right) \equiv \left(Ev, y, z, n\right) \{v, y, z, n \leqq x \& n \text{ Var } v \& \text{Typ}_n(z) \& \text{Form}(y) \& Q(z, y, v) \& x = (v \text{ Gen } y) \text{ Imp } [Sb \left(y \substack{v\\z}\right)]\}$ % TODO } fehlt
