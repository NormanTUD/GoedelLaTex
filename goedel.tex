...
Zeichenketten bearbeiten. Die mathematische Formel wird dabei nur sekundär inhaltlich
...
Kette an XOR und NICHT-Operationen.

Gödel zeigte, dass das nicht ist, möglich alle wahren Aussagen zu beweisen, 
...
der Nummer 4922 ist nicht beweisbar\flq. Wenn aber letzterer Satz gerade 
...
\frq f\flq\ zu 3, \frq$\thicksim$\flq\ zu 5. Außerdem nutzt er die Eineindeutigkeit von
...
\begin{enumerate}
	...
	\item \frq$\thicksim ffff0$\flq\ (mit der peano'schen Nachfolgerfunktion $f$)\mnote{Siehe dazu § \refsatz{Z(n)}}
	\item Nun nehmen wir die Position $p$ im String (angefangen von links mit 1)
		...
		Primfaktorzerlegung prinzipiell wieder 1:1 in den Ursprungssatz zurückwandeln.
\end{enumerate}
...
$$
(n): \overline{\text{Bew}}\left(n\right)
...
diese Zahl tatsächlich aufzuschreiben; es wäre nur sehr umständlich, siehe Fußnote \ref{leichtaufzuschreiben}.}), 
...
Für solche Sätze sind Systeme wie das der Principia Mathematica prinzipiell überflüssig,
...
Das setzt -- ähnlich wie das Halteproblem -- der Theorie der Algorithmen überhaupt
enge Grenzen.
...
Schreibweise übertragen. Trotz größtmöglicher Mühe kann ich dabei natürlich
nicht vermeiden, dass sich eventuell Tipp- oder Verständnisfehler eingeschlichen
haben.
