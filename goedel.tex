...
(PM)\footnote{\goedelcite{pmgoedel}. Zu den Axiomen
...
der Mengenlehre\footnote{Vgl. \goedelcite{zehnvls}. \goedelcite{axiomatisierungmengenlehre}. 
Journ. f. reine u. angew. Math. 154 (1925), 160 (1929).
Wir bemerken, daß man zu den in der
...
zufällig) stellt sich heraus, daß diese Formel gerade
...
später vorkommender), vgl. \goedelcite{aussagenkalkuel}.},
...
$$ R\left(x_1 \dots x_n\right) \thicksim \left[\phi\left(x_1 \dots x_n\right) = 0\right]\footnote{Für alle inhaltlichen (insbes. auch die metamathematischen) Überlegungen wird die \so{Hilbert}sche Symbolik verwendet. Vgl. \goedelcite{hilbertackermann}, Berlin 1928.}$$
...
Transfinite fortsetzen läßt. (Vgl. \goedelcite{ueberdasunendliche}. S. 184), während
...
unentscheidbare Probleme des engeren Funktionenkalküls}\footnote{Vgl. \goedelcite{hilbertackermann}. 
...
Gegenbeispiels beweisbar ist)\footnote{In meiner Arbeit: \goedelcite{goedelvollstaendigkeit},
...
Mathematik\footnote{Vgl. \goedelcite{hilbertschebeweistheorie}.}
