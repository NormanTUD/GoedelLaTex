...
\begin{enumerate}[1.]
	\item $x/y \equiv \left(Ez\right) \left[z \leqq x \& x = y.z\right]$\footnote{Das Zeichen $\equiv$ wird im Sinne von \glqq Definitionsgleichheit\grqq\ verwendet, vertritt also bei Definitionen entweder $=$ oder $\thicksim$ (im übrigen ist
