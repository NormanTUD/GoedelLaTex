...
\begin{enumerate}[1.]
	...
	\left(n\right) [n \leqq l\left(x\right) \longrightarrow (n Gl z = n Gl x] \&
	\left(n\right) \left[0 < n \leqq (l(y) \longrightarrow (n + l\left(x\right)) Gl z = n Gl y\right]\right\}$
	...
	\item $\text{Form}\left(x\right) \equiv \left(En\right) \left\{n \leqq \left(Pr \left[l\left(x\right)^2\right]\right)^{x.\left[l\left(x\right)\right]^2} \& FR\left(n\right) \& x = \left[l\left(n\right)\right] Gl n\right\}$\footnote{Die Abschätzung $n \leqq (Pr \left[l\left(x\right)^2\right])^{x l\left(x\right)^2}$ 
		...
		höchstens $\frac{l\left(x\right)[l\left(x\right) + 1]}{2} \leqq l\left(x\right)^2$. 
	...
	\item $v Fr x \equiv \left(En\right) [n \leqq l\left(x\right) \& v Fr n, x]$
	...
	\item $A_1 - Ax\left(x\right) \equiv \left(Ey\right) \left[y \leqq x\& \text{Form }(y) \& x = (y \text{ Dis } y) \text{ Imp } y\right]$
...
\begin{equation}
	Bw_x\left(x\right) \equiv \left(n\right) [ n \leqq l\left(x\right) \longrightarrow Ax(n Gl x) \lor n Gl x) \epsilon \chi \lor
\end{equation} % ] fehlt
\begin{equation*}
	\left(Ep, q\right) \left\{0 < p, q < n \& Fl\left(n Gl x, p Gl x, q Gl x\right)\right\}] \& l\left(x\right) > 0
\end{equation*} % [ fehlt
...
$$
n \equiv \left[\text{mod }(1 + \left(i + 1 l!\right)\right]\text{ für } i = 0, 1 \dots k - 1
		$$ % TODO missing )
