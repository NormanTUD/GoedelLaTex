...
weil er eben nicht aus den Axiomen herleitbar ist (d.\,h. unbeweisbar).
...
nicht beweisbar\flq\mnote{Dieser Satz könnte auch aussagen: $\thicksim \thicksim \text{Bew}(4922) $, wenn
...
eineindeutig eine eineindeutige Nummer zuzuordnen, indem er einige Konstanten 
definiert, z.\,B. wird \frq 0\flq\ zu 1, \frq f\flq\ zu 3, 
\frq$\thicksim$\flq\ zu 5. 
...
\begin{enumerate}
	...
	\item Nun nehmen wir die Position $p$ im String (angefangen von links mit 1)\mnote{Siehe dazu § \refsatz{Z(n)}}
		...
		können wir, da es unendlich viele Primzahlen gibt\mnote{Die Eineindeutigkeit der Zuordnung von Zahlenwerten
...
Wenn wir also einen Satz der Form:\mnote{\customlabel{luegeeins}{\arabic{commentaryNumber}} 
Kommentar \ref{luegezwei} ist richtig.}
...
weitere Menge gibt. Aber so ganz versteh ichs noch nicht}%TODO
