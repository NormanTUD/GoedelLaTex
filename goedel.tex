...
\mnote{$l\left(x\right) \equiv \exists y: y \leqq x \wedge y Pr x > 0 \wedge \left(y + 1\right) Pr x = 0$}
	...
	$\left.		\left(n\right) \left[n \leqq l\left(x\right) \longrightarrow n Gl\ z = n Gl\ x\right] \&
			\left(n\right) \left[0 < n \leqq l\left(y\right) \longrightarrow \left(n + l\left(x\right)\right) Gl z = n Gl y\right]
		\right\}$
