...
\mnote{$\exists n: n \in K \wedge \thicksim Bew \left[R\left(n\right); n\right]$, vgl. § 46}
\begin{equation}
\label{formel1}
...
\mnote{$\left(n\right) N x \equiv \text{\glqq}f\text{\grqq .} \left(n - 1\right) N x$, die 3 ist das \glqq $f$\grqq, vgl. § 9}
...
\mnote{$A_1 - Ax\left(x\right) \equiv \exists y: y \leqq x \wedge \text{Form }\left(y\right) \wedge x = \left(y \lor y\right) \supset y$, vgl. § 14, 23, 32, 34}
% Was bringt y \lor y???
