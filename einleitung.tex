...
aber auch das \frq \textsc{Gödel}problem\flq\ hat.}
...
\subsection*{Die \text{\citefield{principiamathematicavol1}{title}} und die Typentheorie}
...
\frq verboten\flq\mnote{$\longrightarrow$ Typentheorie, vgl. \cite{septypetheory}}. 
