...
\centeredquote{Das Muster einer vollständigen Fiction ist die Logik.
Hier wird ein Denken erdichtet, wo ein Gedanke als Ursache eines anderen 
...
einen Simplificationsapparat filtriren: bringen wir es zu einer 
Zeichenschrift und Mittheilbarkeit und Merkbarkeit der logischen Vorgänge.
Also: das geistige Geschehen zu betrachten, wie als ob es dem Schema jener 
...
unerkannt bleibt, ist mein Kummer; ich freue mich, daß es vielmehr eine 
Art von Erkenntniß geben kann und bewundere die Complicirtheit dieser 
...
Gedächtniß ist nur möglich vermöge einer Abkürzung eines geistigen Vorgangs zum Zeichen.\\
Die Zeichenschrift.\\\\
Erklärung: das ist der Ausdruck eines neuen Dinges vermittelst
